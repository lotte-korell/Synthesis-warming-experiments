...
## Load data, it will load the function from a R project, so you either need to create one
...
csv_read <- c(Div.data_local = "Temp_data_final.csv", Div.data_gamma = "Temp_data_gamma_final.csv", 
              Comp_data_final = "Temp_comp_data_final.csv", biome = "Biome.csv", 
              grand_mean = "Temp_grand_mean.csv")
